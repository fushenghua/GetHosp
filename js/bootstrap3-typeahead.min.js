...
function (a, b) {
    ...
    b.prototype = {
        ...
        process: function (b) {
            ...
            b = this.sorter(b),
            b.length || this.options.addItem ? (b.length > 0 ? this.$element.data("active", b[0]) : this.$element.data("active", null), this.options.addItem && b.push(this.options.addItem), "all" == this.options.items ? this.render(b).show() : this.render(b.slice(0, this.options.items)).show()) : this.shown ? this.hide() : this
        },
        matcher: function (a) {
    ...
    a.fn.typeahead = function (c) {
        ...
        return "string" == typeof c && "getActive" == c ? this.data("active") : this.each(function () {
            ...
            "string" == typeof c && (d.length > 1 ? f[c].apply(f, Array.prototype.slice.call(d, 1)) : f[c]())
        })
    },
